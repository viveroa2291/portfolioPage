...
<body>
    ...
    <main>
        ...
        <p>Hello,</p>
        <p>My name is Adan Vivero. I have a Bachelors of Science degree majoring in computer science from the University of Wisconsin-Eau Claire. I currently reside in Madison Wisconsin, however have residency in the northwest suburb of Chicago, Mount Prospect.</p>
    </main>
    <?php 
